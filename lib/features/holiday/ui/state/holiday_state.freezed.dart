...
HolidayState _$HolidayStateFromJson(Map<String, dynamic> json) {
  return _HolidayState.fromJson(json);
}

/// @nodoc
mixin _$HolidayState {
  String? get errorListMessage => throw _privateConstructorUsedError;
  bool get isLoadingList => throw _privateConstructorUsedError;
  List<HolidayData> get holidayList => throw _privateConstructorUsedError;

  /// Serializes this HolidayState to a JSON map.
...
abstract class $HolidayStateCopyWith<$Res> {
  factory $HolidayStateCopyWith(
    HolidayState value,
    $Res Function(HolidayState) then,
...
class _$HolidayStateCopyWithImpl<$Res, $Val extends HolidayState>
  ...
  @override
  $Res call({
    Object? errorListMessage = freezed,
    Object? isLoadingList = null,
    Object? holidayList = null,
  }) {
    return _then(
      _value.copyWith(
            errorListMessage: freezed == errorListMessage
                ? _value.errorListMessage
                : errorListMessage // ignore: cast_nullable_to_non_nullable
                      as String?,
...
abstract class _$$HolidayStateImplCopyWith<$Res>
  ...
  factory _$$HolidayStateImplCopyWith(
    _$HolidayStateImpl value,
    $Res Function(_$HolidayStateImpl) then,
...
class __$$HolidayStateImplCopyWithImpl<$Res>
  ...
  __$$HolidayStateImplCopyWithImpl(
    _$HolidayStateImpl _value,
    $Res Function(_$HolidayStateImpl) _then,
  ) : super(_value, _then);
...
class _$HolidayStateImpl implements _HolidayState {
  const _$HolidayStateImpl({
    ...
    final List<HolidayData> holidayList = const [],
  }) : _holidayList = holidayList;

  factory _$HolidayStateImpl.fromJson(Map<String, dynamic> json) =>
      _$$HolidayStateImplFromJson(json);
  ...
  final List<HolidayData> _holidayList;
  @override
  @JsonKey()
  List<HolidayData> get holidayList {
  ...
  @override
  String toString() {
    return 'HolidayState(errorListMessage: $errorListMessage, isLoadingList: $isLoadingList, holidayList: $holidayList)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.errorListMessage, errorListMessage) ||
                other.errorListMessage == errorListMessage) &&
  ...
  Map<String, dynamic> toJson() {
    return _$$HolidayStateImplToJson(this);
  }
}
...
abstract class _HolidayState implements HolidayState {
  ...
  factory _HolidayState.fromJson(Map<String, dynamic> json) =
      _$HolidayStateImpl.fromJson;

  @override
  String? get errorListMessage;
  @override
