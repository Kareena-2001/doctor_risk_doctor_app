...
final mockCasesProvider = Provider<List<LegalNoticeModel>>((ref) {
  return [
    LegalNoticeModel(
      ...
      description:
          "Alleged misdiagnosis claim concerning postoperative management protocols.",
      status: "Active",
      ...
      remarks: [
        LegalRemark(
          remarkText:
              "Initial response copy prepared and verified by the legal panel.",
        ...
        LegalRemark(
          remarkText:
              "Medical summary report signed off by the Head of Surgery.",
    ...
    LegalNoticeModel(
      ...
      description:
          "Legal notice served regarding outstanding equipment lease clearances.",
      status: "In-Progress",
      ...
      remarks: [
        LegalRemark(
          remarkText:
              "Demand notice successfully served to tenant via registered post.",
    ...
    LegalNoticeModel(
      ...
      description:
          "Notice regarding dishonored consulting fee retainer checks.",
      status: "Closed",
      uploadedFiles: [],
      addedOn: "06 Mar 2026",
