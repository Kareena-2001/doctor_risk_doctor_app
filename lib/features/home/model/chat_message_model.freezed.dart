...
class _$ChatMessageModelImpl implements _ChatMessageModel {
  ...
  @override
  String toString() {
    return 'ChatMessageModel(id: $id, text: $text, sender: $sender, timestamp: $timestamp, isSending: $isSending)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, text, sender, timestamp, isSending);
