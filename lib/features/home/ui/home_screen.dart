...
class _HomeScreenState extends ConsumerState<HomeScreen>
  ...
  final Set<int> _registeredEventIds = <int>{};
  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      ref.read(eventsViewModelProvider.notifier).fetchUpcomingEvents();
    });
  }
  ...
  Widget _buildMainContent(bool isDark, List<PolicyModel> plans) {
    final upcomingEvents = ref
        .watch(eventsViewModelProvider)
        .upcomingEvents
        .valueOrNull
        ?.data;
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          final canRegister =
              event.registerButton && !_registeredEventIds.contains(event.id);
