...
abstract class $LoginResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool status, int code, String msg, LoginData data});
...
class _$LoginResponseImpl implements _LoginResponse {
  ...
  @override
  String toString() {
    return 'LoginResponse(status: $status, code: $code, msg: $msg, data: $data)';
  }
...
class _$LoginDataImpl implements _LoginData {
  ...
  @override
  String toString() {
    return 'LoginData(accessToken: $accessToken)';
  }
