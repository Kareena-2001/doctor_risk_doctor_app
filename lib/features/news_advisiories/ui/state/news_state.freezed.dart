...
/// @nodoc
mixin _$NewsState {
  List<NewsAdvisoryModel> get news => throw _privateConstructorUsedError;
...
abstract class $NewsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<NewsAdvisoryModel> news});
}
...
class _$NewsStateImpl implements _NewsState {
  const _$NewsStateImpl({final List<NewsAdvisoryModel> news = const []})
    : _news = news;

  final List<NewsAdvisoryModel> _news;
  @override
  @JsonKey()
  List<NewsAdvisoryModel> get news {
...
abstract class _NewsState implements NewsState {
  const factory _NewsState({final List<NewsAdvisoryModel> news}) =
      _$NewsStateImpl;
